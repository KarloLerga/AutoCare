...
public class HelperSmokeTest {
    public static void main(String[] args) {
        ...
        check(EstimateSelection.conflicts(Set.of("FRONT_BRAKES"), "FRONT_DISCS_PADS").contains("FRONT_BRAKES"));
        ...
        check(EstimateSelection.conflicts(Set.of("TIMING_BELT_PUMP"), "COOLANT").contains("TIMING_BELT_PUMP"));
