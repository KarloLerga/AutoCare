...
## 1. Postojeci resurs, ne nova baza
Korisnik koristi postojeci Azure SQL Database Free Offer resurs. Poznat host `auto-care.database.windows.net`, port 1433 i SQL korisnik `karlolerga`. Stvarno ime baze drzi se samo u privatnoj konfiguraciji; ne zakljucivati ga iz servera, resource groupa, imena repozitorija ili povijesnih primjera.
...
importer koristi JDBC batching/staging jer milijun JPA persist-ova nije prikladno za inicijalno punjenje.
