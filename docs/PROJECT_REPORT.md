...
Slika `architecture.png` pokazuje odgovornosti. `domain.png` prikazuje domenske veze i Strategy. `erd.png` prikazuje fizicke tablice/FK; potpuna polja i owning-side odluke su u DATABASE_AND_JPA.md. DOT/Mermaid izvori su prilozeni za reprodukciju, a ERD nije tvrdnja o vec introspektiranoj Azure bazi.
