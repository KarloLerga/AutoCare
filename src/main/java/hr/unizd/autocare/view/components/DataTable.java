...
public final class DataTable<T> extends JPanel {
    ...
    public DataTable(String[] columns, BiFunction<T, Integer, Object> value) {
        ...
        table=new JTable(model) {
            @Override public String getToolTipText(java.awt.event.MouseEvent event) {
                ...
                String escaped=String.valueOf(value).replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;");
    ...
    public void filter(String text) {
        ...
        sorter.setRowFilter(text==null||text.isBlank()?null:RowFilter.regexFilter("(?iu)"+java.util.regex.Pattern.quote(text)));
    }
}
