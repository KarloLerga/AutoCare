...
public final class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        String[] names= {
            "Dashboard", "Vozila", "Odrzavanje", "Servisi", "Problemi", "Profil"
        };
        JPanel[] panels= {
            dashboard, vehicles, maintenance, services, problems, profile
        };
    ...
    public void showPage(String name) {
        ...
        for(Map.Entry<String, JButton> e:navigation.entrySet())e.getValue().setBackground(e.getKey().equals(name)?new Color(0xDFEDF3):Color.WHITE);
    }
    public String page() {
        return page;
    }
