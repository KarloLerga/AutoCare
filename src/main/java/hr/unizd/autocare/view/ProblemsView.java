...
public final class ProblemsView extends JPanel {
    ...
    public final DataTable<ProblemRow> table=new DataTable<>(new String[] {
        "Opis simptoma", "Moguci uzrok", "Podudaranje %", "Procjena", "Datum"
    }, (p, c)->switch(c) {
    ...
    public ProblemsView() {
        ...
        add(table);
        add(Ui.hint("Rjesavanje problema evidentira se kroz Novi servis, ne kroz sam rezultat analize."), BorderLayout.SOUTH);
    }
}
